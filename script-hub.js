...
<html lang="zh-CN">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/Keywos/Script-Hub/main/assets/sub.css"/>
  ...
  <body style="margin-bottom: 160px;">
    ...
    <div id="app">
      ...
      <!-- position: fixed;  -->
      <div style="padding: 1rem; bottom: 1rem; margin-right: 1rem; background-color: var(--bg); border: 3px solid var(--border); border-radius: var(--standard-border-radius);">
